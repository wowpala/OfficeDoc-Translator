...
#            model='THUDM/glm-4-9b-chat',
            messages=[
                {'role': 'system', 'content': f"You are a professional, authentic machine translation engine. Translate the following source text to {target_language}. Output translation directly without any additional text. Don't translate IT term. Don't translate the words beginning with 'Forti'. Don't translate words in single quotes 'output, spoke'. Keep the original words unchanged which you can't recognize."},
